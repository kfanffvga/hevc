#ifndef _CU_TRANSQUANT_BYPASS_FLAG_READER_H_
#define _CU_TRANSQUANT_BYPASS_FLAG_READER_H_

#include "hevc_decoder/vld_decoder/common_cabac_syntax_reader.h"

class CUTransquantBypassFlagReader : public CommonCABACSyntaxReader
{
public:
    CUTransquantBypassFlagReader(CABACReader* cabac_reader, 
                                 CABACInitType init_type);
    virtual ~CUTransquantBypassFlagReader();
